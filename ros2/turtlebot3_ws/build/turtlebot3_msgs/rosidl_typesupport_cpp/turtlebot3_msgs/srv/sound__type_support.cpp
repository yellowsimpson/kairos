...
static const _Sound_Request_type_support_symbol_names_t _Sound_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_msgs, srv, Sound_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_msgs, srv, Sound_Request)),
  }
};
...
{
  return &::turtlebot3_msgs::srv::rosidl_typesupport_cpp::Sound_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot3_msgs, srv, Sound_Request)() {
  return get_message_type_support_handle<turtlebot3_msgs::srv::Sound_Request>();
}
...
static const _Sound_Response_type_support_symbol_names_t _Sound_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_msgs, srv, Sound_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_msgs, srv, Sound_Response)),
  }
};
...
{
  return &::turtlebot3_msgs::srv::rosidl_typesupport_cpp::Sound_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot3_msgs, srv, Sound_Response)() {
  return get_message_type_support_handle<turtlebot3_msgs::srv::Sound_Response>();
}
...
static const _Sound_type_support_symbol_names_t _Sound_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_msgs, srv, Sound)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_msgs, srv, Sound)),
  }
};
...
{
  return &::turtlebot3_msgs::srv::rosidl_typesupport_cpp::Sound_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot3_msgs, srv, Sound)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<turtlebot3_msgs::srv::Sound>();
}

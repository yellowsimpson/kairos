...
# 색상에 따른 지정된 위치로 이동하는 함수
def move_to_position(color):
    if color == 'blue':
        # 파란색 상자의 좌표로 이동
        mc.send_angles([60, 20, 30, -45, -90, 0], 20)  # 예시 좌표입니다.
    elif color == 'yellow':
        # 노란색 상자의 좌표로 이동
        mc.send_angles([30, 10, 40, -30, -90, 0], 20)  # 예시 좌표입니다.
    elif color == 'red':
        # 빨간색 상자의 좌표로 이동
        mc.send_angles([10, 15, 20, -20, -90, 0], 20)  # 예시 좌표입니다.
...
def perform_action():
    ...
    if color:
        ...
        mc.set_gripper_state(0, 20)  # 그리퍼 열기
